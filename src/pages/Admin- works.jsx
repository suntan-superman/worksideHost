...
const Admin = () => {
  ...
  let phElem;
  let phObject;
  const createphonemaskinputn = () => {
    phElem = document.createElement('input');
    return phElem;
  };
  const destroyphonemaskinputFn = () => {
    phObject.destroy();
  };
  const readphonemaskinputFn = () => phObject.value;
  const writephonemaskinputFn = (args) => {
  ...
  const phonemaskinput = {
    create: createphonemaskinputn,
    destroy: destroyphonemaskinputFn,
    read: readphonemaskinputFn,
    write: writephonemaskinputFn,
  };
          ...
          <div className="absolute top-[50px] left-[20px] w-[140px] flex flex-row items-center justify-start">
            ...
            >
              <ColumnsDirective>
                ...
                <ColumnDirective field="primaryphone" headerText="Phone 1" textAlign="Left" width="100" edit={phonemaskinput} />
                <ColumnDirective field="secondaryphone" headerText="Phone 2" textAlign="Left" width="100" edit={phonemaskinput} />
