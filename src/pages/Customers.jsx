...
const Customers = () => {
  ...
  const rowSelected = () => {
    if (grid) {
      ...
      setMessageText('Delete: ' + customersData[selectedrowindex].customername);
      ...
      <div className="relative bg-gainsboro-100 w-full h-[768px] overflow-hidden text-left text-lg text-black font-paragraph-button-text">
        <div className="absolute top-[50px] left-[5px] w-[140px] flex flex-row items-center justify-start">
          <GridComponent dataSource={customersData}
            ...
            ref={g => grid = g}>
            <ColumnsDirective>
              <ColumnDirective field='customername' headerText='Select Customer' textAlign='Center' width='125'/>
              {/* <ColumnDirective field='custName' headerText='Select Customer' textAlign='Center' width='125'/> */}
            </ColumnsDirective>
            <Inject services={[Selection]}/>
          </GridComponent>
        </div>
        {/* <b className="absolute top-[10px] left-[10px] text-2xl">Customers</b> */}
        ...
        <div className="absolute top-[50px] left-[175px] flex flex-row items-center justify-start gap-[25px]">
          ...
          <input
            className={emptyFields.includes('customername') === true
        ...
        <div className="absolute top-[140px] left-[175px] flex flex-row items-center justify-start gap-[35px]">
          ...
          <input
            className={emptyFields.includes('city')
            ...
            value={city} /><b className="relative inline-block w-[40px] shrink-0">State</b>
          <input
            className={emptyFields.includes('state') === true
        ...
        <div className="absolute top-[170px] left-[175px] flex flex-row items-center justify-start gap-[35px]">
          ...
          <input
            className={emptyFields.includes('status') === true
          ...
          <DatePickerComponent
            ...
            className={emptyFields.includes('date') ? 'errorDatefieldStyle' : 'datefieldStyle'}
        ...
        <div className="fixed right-10 top-[280px] gap-[10px]" style={{ zIndex: '1000' }}>
          <button
            type="button"
